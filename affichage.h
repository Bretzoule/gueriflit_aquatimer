...
/*!
  \fn void init(int*** ppint_grille, int int_tailleGrille)
...
/*!
  \fn void afficherGrille(int** ppint_grille, int int_tailleGrille)
...
/*!
  \fn void afficherEnmie(int** ppint_grille,int int_tailleGrille)
